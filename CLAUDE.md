...
This project is indexed by GitNexus as **wise** (5482 symbols, 14659 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/wise/process/{processName}` — trace the full execution flow step by step
