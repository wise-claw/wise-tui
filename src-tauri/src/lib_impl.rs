use crate::{
    ...
    cursor_agent, cursor_acp_commands, cursor_disk, fcc_traces, free_claude_code, opencode_go_proxy,
    code_review_commands, cua_driver, dingtalk_enterprise_bot, dingtalk_stream_gateway, extensions, git_commands,
    main_window, mcp, my_extensions, native_cli_sessions,
...
pub fn run() {
    ...
    let builder = tauri::Builder::default()
        ...
        .setup(|app| {
            ...
            crate::collaboration::bridge::spawn_maintenance(app.handle().clone());
            {
    ...
    builder
        .invoke_handler(tauri::generate_handler![
            ...
            crate::collaboration::commands::collab_list_agents,
            crate::collaboration::commands::collab_get_agent,
            crate::collaboration::commands::collab_get_agent_revision,
            crate::collaboration::commands::collab_create_agent,
            crate::collaboration::commands::collab_update_agent,
            crate::collaboration::commands::collab_publish_agent,
            crate::collaboration::commands::collab_rollback_agent,
            crate::collaboration::commands::collab_set_agent_status,
            crate::collaboration::commands::collab_duplicate_agent,
            crate::collaboration::commands::collab_check_agent,
            crate::collaboration::commands::collab_bind_agent,
            crate::collaboration::commands::collab_unbind_agent,
            crate::collaboration::commands::collab_list_repository_agents,
            crate::collaboration::commands::collab_effective_config,
            crate::collaboration::commands::collab_capability_matrix,
            crate::collaboration::commands::collab_probe_engine,
            crate::collaboration::commands::collab_list_memories,
            crate::collaboration::commands::collab_add_memory,
            crate::collaboration::commands::collab_update_memory,
            crate::collaboration::commands::collab_delete_memory,
            crate::collaboration::commands::collab_clear_memories,
            crate::collaboration::commands::collab_memory_revisions,
            crate::collaboration::commands::collab_dispatch_intent,
            crate::collaboration::commands::collab_create_requirement,
            crate::collaboration::commands::collab_list_requirements,
            crate::collaboration::commands::collab_requirement_snapshot,
            crate::collaboration::commands::collab_requirements_for_session,
            crate::collaboration::commands::collab_events_since,
            crate::collaboration::commands::collab_list_messages,
            crate::collaboration::commands::collab_requeue_message,
            crate::collaboration::commands::collab_revise_requirement,
            crate::collaboration::commands::collab_control_requirement,
            crate::collaboration::commands::collab_transfer_owner,
            crate::collaboration::commands::collab_publish_plan,
            crate::collaboration::commands::collab_resolve_decision,
            crate::collaboration::commands::collab_task_detail,
            crate::collaboration::commands::collab_explain_requirement,
            crate::collaboration::commands::collab_deliverables,
            crate::collaboration::commands::collab_refresh_acceptance,
            crate::collaboration::commands::collab_accept,
            crate::collaboration::commands::collab_merge_changes,
            crate::collaboration::commands::collab_usage_summary,
            crate::collaboration::commands::collab_import_v1,
            crate::collaboration::commands::collab_legacy_history,
            crate::collaboration::commands::collab_set_legacy_target,
            crate::collaboration::commands::collab_claim,
            crate::collaboration::commands::collab_confirm_launch,
            crate::collaboration::commands::collab_bind_session,
            crate::collaboration::commands::collab_heartbeat,
            crate::collaboration::commands::collab_finish_attempt,
            crate::collaboration::commands::collab_request_stop,
            crate::collaboration::commands::collab_mark_stop_pending,
            crate::collaboration::commands::collab_reconcile,
            crate::collaboration::commands::collab_active_attempts,
            crate::collaboration::commands::collab_bridge_status,
            crate::collaboration::commands::collab_run_verification,
            crate::collaboration::commands::collab_revalidate_artifact,
            crate::collaboration::commands::collab_invalidate_artifact,
            crate::collaboration::commands::collab_pending_runtime_stops,
            crate::collaboration::commands::collab_mark_runtime_stopped,
            crate::collaboration::commands::collab_list_resources,
            crate::collaboration::commands::collab_resource_versions,
            crate::collaboration::commands::collab_create_resource,
            crate::collaboration::commands::collab_publish_resource_version,
            crate::collaboration::commands::collab_grant_resource,
            crate::collaboration::commands::collab_revoke_resource_grant,
            crate::collaboration::commands::collab_set_resource_visibility,
            crate::collaboration::commands::collab_archive_resource,
            crate::collaboration::commands::collab_search_resources,
            crate::collaboration::commands::collab_read_resource,
            crate::collaboration::commands::collab_subscribe_resource,
            crate::collaboration::commands::collab_resource_updates,
            crate::collaboration::commands::collab_suggest_resource,
            crate::collaboration::commands::collab_list_resource_suggestions,
            crate::collaboration::commands::collab_resolve_resource_suggestion,
            crate::collaboration::commands::collab_list_spaces,
            crate::collaboration::commands::collab_create_space,
            crate::collaboration::commands::collab_set_space_member,
            crate::collaboration::commands::collab_due_outbox,
            crate::collaboration::commands::collab_ack_outbox,
            crate::collaboration::commands::collab_channel_inbox,
            crate::collaboration::commands::collab_mark_inbox_read,
            ...
            git_commands::git_flow_info,
            git_commands::git_flow_init,
            git_commands::git_flow_feature_start,
            git_commands::git_flow_feature_finish,
            git_commands::git_flow_release_start,
            git_commands::git_flow_release_finish,
            git_commands::git_flow_hotfix_start,
            git_commands::git_flow_hotfix_finish,
            ...
            codex_models::codex_list_models,
            ...
            codex_rpc_disk::load_codex_rpc_session_jsonl_command,
            codex_rpc_disk::list_codex_rpc_disk_sessions,
            ...
            claude_model_profiles::clear_codex_user_settings,
            ...
            claude_commands::memory::ensure_claude_rules_dir,
            claude_commands::memory::get_claude_memory_status,
            claude_commands::memory::set_claude_auto_memory_enabled,
            claude_commands::memory::read_claude_auto_memory_file,
            claude_commands::memory::save_claude_auto_memory_file,
            ...
            native_cli_sessions::list_native_cli_disk_sessions,
            ...
            claude_commands::attachments::wise_fetch_remote_image,
            claude_commands::attachments::wise_read_local_image,
            claude_commands::attachments::wise_read_clipboard_image,
            ...
            skills::codex_user_skills::list_codex_user_skills,
            agents_explorer::agents_explorer_scan,
            agents_explorer::agents_explorer_read_file,
            ...
            agent_registry::agent_registry_check_latest,
            agent_registry::agent_registry_check_updates,
            ...
            cursor_disk::list_cursor_disk_sessions,
            cursor_agent::execute_cursor_code,
            cursor_acp_commands::execute_cursor_acp,
            cursor_acp_commands::interrupt_cursor_acp,
            cursor_acp_commands::shutdown_cursor_acp,
