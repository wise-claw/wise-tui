  ...
  return (
    ...
    <LazyAppWorkspaceLayout
      ...
      leftSidebarProps={{
        ...
        onExecutionEnvironmentDispatchHistoryDaysChange: executionEnvironmentDispatchHistory.save,
      ...
      claudeSessionsProps={{
        ...
        onUpdateSessionCodexReasoningEffort: updateSessionCodexReasoningEffort,
        onUpdateSessionClaudeReasoningEffort: updateSessionClaudeReasoningEffort,
        onUpdateSessionExecutionEngine: updateSessionExecutionEngine,
        ...
        onClosePaneSlot: handleClosePaneSlot,
