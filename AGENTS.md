...
This project is indexed by GitNexus as **wise** (23370 symbols, 41929 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
