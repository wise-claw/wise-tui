...
This project is indexed by GitNexus as **wise** (22157 symbols, 39508 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
