---
name: "source-command-cc-workflow-ai-editor"
...
# source-command-cc-workflow-ai-editor

Use this skill when the user asks to run the migrated source command `cc-workflow-ai-editor`.
