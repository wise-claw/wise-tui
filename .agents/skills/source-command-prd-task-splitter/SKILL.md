---
name: "source-command-prd-task-splitter"
description: "Execute CC Workflow Studio workflow \"prd-task-splitter\" (Codex + cc-workflow-studio MCP)."
---

# source-command-prd-task-splitter

Use this skill when the user asks to run the migrated source command `prd-task-splitter`.
